...
Si votre favicon est un png, déposez votre image dans votre dossier local `static/aws/images/` et nommez le `favicon.png`
...
```html
<link rel="shortcut icon" href="/aws/images/favicon.png" type="image/x-icon" />
```
...
![Variante rouge](/en/basics/style-customization/aws/images/red-variant.png?width=60pc)
...
![Variante bleue](/en/basics/style-customization/aws/images/blue-variant.png?width=60pc)
...
![Variante verte](/en/basics/style-customization/aws/images/green-variant.png?width=60pc)
