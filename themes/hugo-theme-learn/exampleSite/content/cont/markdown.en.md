...
```markdown
![Minion](https://octodex.github.com/aws/images/minion.png)
```
![Minion](https://octodex.github.com/aws/images/minion.png)

or
```markdown
![Alt text](https://octodex.github.com/aws/images/stormtroopocat.jpg "The Stormtroopocat")
```
![Alt text](https://octodex.github.com/aws/images/stormtroopocat.jpg "The Stormtroopocat")
...
[id]: https://octodex.github.com/aws/images/dojocat.jpg  "The Dojocat"
...
```markdown
![Minion](https://octodex.github.com/aws/images/minion.png?width=20pc)
```

![Minion](https://octodex.github.com/aws/images/minion.png?width=20pc)

```markdown
![Minion](https://octodex.github.com/aws/images/minion.png?height=50px)
```

![Minion](https://octodex.github.com/aws/images/minion.png?height=50px)

```markdown
![Minion](https://octodex.github.com/aws/images/minion.png?height=50px&width=300px)
```
...
```markdown
![stormtroopocat](https://octodex.github.com/aws/images/stormtroopocat.jpg?classes=shadow)
```
![stormtroopocat](https://octodex.github.com/aws/images/stormtroopocat.jpg?width=40pc&classes=shadow)

```markdown
![stormtroopocat](https://octodex.github.com/aws/images/stormtroopocat.jpg?classes=border)
```
![stormtroopocat](https://octodex.github.com/aws/images/stormtroopocat.jpg?width=40pc&classes=border)

```markdown
![stormtroopocat](https://octodex.github.com/aws/images/stormtroopocat.jpg?classes=border,shadow)
```
![stormtroopocat](https://octodex.github.com/aws/images/stormtroopocat.jpg?width=40pc&classes=border,shadow)
...
```markdown
![Minion](https://octodex.github.com/aws/images/minion.png?featherlight=false)
```
