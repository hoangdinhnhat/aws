...
pre : " <b> 3.1. </b> "
---
![SSMPublicinstance](/aws/images/arc-02.png)
...
![Connect](/aws/images/3.connect/001-connect.png)
...
![Connect](/aws/images/3.connect/002-connect.png)


4. Then select **Public Linux Instance** and click **Start session** to access the instance.

![Connect](/aws/images/3.connect/003-connect.png)
...
![Connect](/aws/images/3.connect/004-connect.png)
