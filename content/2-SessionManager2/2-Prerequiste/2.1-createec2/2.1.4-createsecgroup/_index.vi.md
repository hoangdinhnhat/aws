...
![SG](/aws/images/2.prerequisite/019-createsg.png)
...
![SG](/aws/images/2.prerequisite/020-createsg.png)
...
![SG](/aws/images/2.prerequisite/021-createsg.png)
...
![SG](/aws/images/2.prerequisite/024-createsg.png)

5. Kéo chuột xuống phía dưới.
  + Xóa **Outbound rule**.
  
![SG](/aws/images/2.prerequisite/025-createsg.png)

6. Thêm **Inbound rule** cho phép TCP 443 đến từ 10.10.0.0/16 ( CIDR của **Lab VPC** chúng ta đã tạo ).
  + Click **Create security group**.

![SG](/aws/images/2.prerequisite/026-createsg.png)
