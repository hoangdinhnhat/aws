...
![VPC](/aws/images/2.prerequisite/003-createsubnet.png)
...
![VPC](/aws/images/2.prerequisite/004-createsubnet.png)
...
![VPC](/aws/images/2.prerequisite/005-createsubnet.png)

5. Click chọn **Enable auto-assign public IPv4 address**.
  + Click **Save**.

![VPC](/aws/images/2.prerequisite/006-createsubnet.png)

6. Click **Internet Gateways**.
  + Click **Create internet gateway**.
  
![VPC](/aws/images/2.prerequisite/007-createigw.png)

7. Tại trang **Create internet gateway**.
  + Tại mục **Name tag** điền **Lab IGW**.
  + Click **Create internet gateway**.
  
![VPC](/aws/images/2.prerequisite/008-createigw.png)

8. Sau khi tạo thành công, click **Actions**.
  + Click **Attach to VPC**.
 
![VPC](/aws/images/2.prerequisite/009-createigw.png)
...
![VPC](/aws/images/2.prerequisite/010-createigw.png)

10. Tiếp theo chúng ta sẽ tạo một custom route table để gán vào **Lab Public Subnet**.
  + Click **Route Tables**.
  + Click **Create route table**.

![VPC](/aws/images/2.prerequisite/011-creatertb.png)
...
![VPC](/aws/images/2.prerequisite/012-creatertb.png)
...
![VPC](/aws/images/2.prerequisite/013-creatertb.png)
...
![VPC](/aws/images/2.prerequisite/014-creatertb.png)

15. Tại trang **Edit subnet associations**. 
  + Click chọn **Lab Public Subnet**.
  + Click **Save associations**.

![VPC](/aws/images/2.prerequisite/015-creatertb.png)
...
![VPC](/aws/images/2.prerequisite/016-creatertb.png)
